  ...
  return (
    <div style={{ marginBottom: "140px" }} >
      <div className="row">
        ...
        <div className="col">
          <h3 style={{ marginTop: "10px" }}>About Us : </h3>
          <p>
          ...
          <p>With the help of online booking people can book their tickets online through internet, sitting in their home by a single click of mouse. Using their credit cards people can easily get their tickets done within minutes.
          </p></div>
        <div className="col"></div>
      </div>
    </div>
